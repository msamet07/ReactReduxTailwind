...
const ProductCard = ({ dt }) => {
  ...
  return (
    <div className="w-[200px] h-[200px] relative m-2 rounded-md ">
      ...
      <div className="absolute left-0 bottom-0 bg-stone-400 text-white w-full px-2">
      ...
      {openEdit && (
        <div className="bg-[#57534e] border border-white text-white absolute top-4 right-2 p-2 text-sm ">
          <div
